...
Module RowColOpsOverField
  (FM : FieldModule).

Include LinAlgOverField FM.
...
Definition get_col {m n} (T : GenMatrix m n) (i : nat) : GenVector m :=
...
Definition reduce_vecn {n} (v : GenVector (S n)) : GenVector n :=
  fun x y => if x <? n
             then v x y
             else v (1 + x) y.
...
Definition get_minor {m n} (A : GenMatrix (S m) (S n)) (row col : nat) : GenMatrix m n :=
  fun x y => (if x <? row 
              then (if y <? col 
                    then A x y
                    else A x (1+y))
...
Definition col_wedge {m n} (T : GenMatrix m n) (v : GenVector m) (spot : nat) : GenMatrix m (S n) :=
  fun i j => if j <? spot 
             then T i j
             else if j =? spot
                  then v i 0
...
*)
Definition col_append {m n} (T : GenMatrix m n) (v : GenVector m) : GenMatrix m (S n) :=
  col_wedge T v n.
...
*)
Definition row_append {m n} (T : GenMatrix m n) (v : GenMatrix 1 n) : GenMatrix (S m) n :=
  row_wedge T v m. 
...
Definition row_scale_many {m n} (T : GenMatrix m n) (as' : GenVector m) : GenMatrix m n := 
...
Definition gen_new_col (m n : nat) (T : GenMatrix m n) (as' : GenVector n) : GenVector m :=
...
Definition col_add_many {m n} (T : GenMatrix m n) (as' : GenVector n) (col : nat) : GenMatrix m n :=
  fun i j => if (j =? col) 
...
Definition row_add_each {m n} (T : GenMatrix m n) (as' : GenVector m) (row : nat) : GenMatrix m n := 
  T .+ (as' × get_row T row).
...
Lemma rvn_is_rr_n : forall {n : nat} (v : GenVector (S n)),
...
Lemma WF_reduce_vecn : forall {n} (v : GenVector (S n)),
...
Lemma get_minor_is_redrow_redcol : forall {m n} (A : GenMatrix (S m) (S n)) (row col : nat),
...
Lemma get_minor_is_redcol_redrow : forall {m n} (A : GenMatrix (S m) (S n)) (row col : nat),
...
Lemma WF_get_minor : forall {m n} (A : GenMatrix (S m) (S n)) (row col : nat),
  row < S m -> col < S n -> WF_GenMatrix A -> WF_GenMatrix (get_minor A row col).
Proof. intros.
...
Lemma WF_row_scale_many : forall {m n} (T : GenMatrix m n) (as' : GenVector n),
...
Lemma WF_gen_new_col : forall {m n} (T : GenMatrix m n) (as' : GenVector n),
...
Lemma WF_col_add_many : forall {m n} (T : GenMatrix m n) (as' : GenVector n) (col : nat),
...
Lemma WF_col_wedge : forall {m n} (T : GenMatrix m n) (v : GenVector m) (spot : nat),
...
Lemma WF_row_add_each : forall {m n} (row : nat) (as' : GenVector m) (T : GenMatrix m n),
...
Lemma get_col_mult : forall {m n o : nat} (i : nat) (A : GenMatrix m n) (B : GenMatrix n o),
...
Lemma get_row_mult : forall {m n o} (i : nat) (A : GenMatrix m n) (B : GenMatrix n o),
  (get_row A i) × B = get_row (A × B) i.
Proof. intros. unfold get_row, GMmult.
       prep_genmatrix_equality.
       bdestruct (x =? 0).
       - reflexivity.
       - apply @big_sum_0. intros.
...
Lemma det_by_get_col : forall {m n} (A B : GenMatrix m n),
...
Lemma get_col_reduce_wedge_miss : forall {m n} (T : GenMatrix m (S n)) (v : GenVector m) (i : nat),
...
Lemma get_col_reduce_wedge_hit : forall {m n} (T : GenMatrix m (S n)) (v : GenVector m),
  WF_GenMatrix v -> get_col (col_wedge (reduce_col T n) v n) n = v.
Proof. intros.        
       unfold get_col, col_wedge, reduce_col.
       prep_genmatrix_equality. 
       bdestruct (y =? 0).
...
Lemma get_col_over : forall {m n} (T : GenMatrix m (S n)) (i : nat),
  WF_GenMatrix T -> i > n -> 
  get_col T i = Zero.
Proof. intros. 
       prep_genmatrix_equality. 
...
Lemma get_col_col_scale_many : forall {m n} (T : GenMatrix m n) (as' : GenMatrix 1 n) (i : nat),
...
Lemma get_row_row_scale_many : forall {m n} (T : GenMatrix m n) (as' : GenVector m) (i : nat),
...
Lemma col_swap_get_minor_before : forall {n : nat} (A : GenSquare (S n)) (row col c1 c2 : nat),
  col < (S c1) -> col < (S c2) ->
...
Lemma col_scale_get_minor_before : forall {n : nat} (A : GenSquare (S n)) (x y col : nat) (a : F),
...
Lemma col_scale_get_minor_same : forall {n : nat} (A : GenSquare (S n)) (x y col : nat) (a : F),
...
Lemma col_scale_get_minor_after : forall {n : nat} (A : GenSquare (S n)) (x y col : nat) (a : F),
...
Lemma row_scale_get_minor_before : forall {n : nat} (A : GenSquare (S n)) (x y row : nat) (a : F),
...
Lemma row_scale_get_minor_same : forall {n : nat} (A : GenSquare (S n)) (x y row : nat) (a : F),
...
Lemma row_scale_get_minor_after : forall {n : nat} (A : GenSquare (S n)) (x y row : nat) (a : F),
...
Lemma col_add_many_reduce_col_same : forall {m n} (T : GenMatrix m (S n)) (v : GenVector (S n))
                                            (col : nat),
...
Lemma col_wedge_reduce_col_same : forall {m n} (T : GenMatrix m n) (v : GenVector n)
                                         (col : nat),
...
Lemma col_add_many_reduce_row : forall {m n} (T : GenMatrix (S m) n) (v : GenVector n) (col row : nat),
...
Lemma smash_zero : forall {m n} (T : GenMatrix m n) (i : nat),
  WF_GenMatrix T -> smash T (@Zero m i) = T. 
Proof. intros. 
       prep_genmatrix_equality.
       unfold smash, Zero. 
...
Lemma smash_wedge : forall {m n} (T : GenMatrix m n) (v : GenVector m),
...
Lemma get_minor_col_to_front : forall {n} (A : GenSquare (S n)) (col x : nat),
...
Lemma get_minor_row_to_front : forall {n} (A : GenSquare (S n)) (row y : nat),
...
Lemma get_minor_col_replace : forall {n} (A : GenSquare (S n)) (col rep x : nat),
...
Lemma get_minor_row_replace : forall {n} (A : GenSquare (S n)) (row rep y : nat),
...
Lemma get_minor_2x_0 : forall {n} (A : GenSquare (S (S n))) (x y : nat),
  x <= y ->
...
Lemma col_add_split : forall {n} (A : GenSquare (S n)) (i : nat) (c : F),
...
Lemma col_swap_col_add_Si : forall {n} (A : GenSquare n) (i j : nat) (c : F),
...
Lemma col_swap_col_add_0 : forall {n} (A : GenSquare n) (j : nat) (c : F),
...
Lemma col_add_double : forall {m n} (T : GenMatrix m n) (x : nat) (a : F),
  col_add T x x a = col_scale T x (1%G + a)%G.
Proof. intros. 
       prep_genmatrix_equality. 
...
Lemma row_add_double : forall {m n} (T : GenMatrix m n) (x : nat) (a : F),
  row_add T x x a = row_scale T x (1%G + a)%G.
Proof. intros. 
       prep_genmatrix_equality. 
...
Lemma scalar_make_WF : forall {m n} (T : GenMatrix m n) (c : F),
...
Lemma transpose_make_WF : forall {m n} (T : GenMatrix m n),
  (make_WF T) ⊤ = make_WF (T⊤).
Proof. intros. 
...
Lemma gen_new_vec_0 : forall {m n} (T : GenMatrix m n) (as' : GenVector n),
...
Lemma col_add_many_0 : forall {m n} (T : GenMatrix m n) (as' : GenVector n) (col : nat),
...
Lemma gen_new_vec_mat_equiv : forall {m n} (T : GenMatrix m n) (as' bs : GenVector n),
...
Lemma col_add_many_mat_equiv : forall {m n} (T : GenMatrix m n) (as' bs : GenVector n) (col : nat),
...
Lemma row_add_each_0 : forall {m n} (T : GenMatrix m n) (v : GenVector m) (row : nat) ,
...
Lemma gen_new_col_is_mul : forall {m n} (T : GenMatrix m n) (as' : GenVector n),
  WF_GenMatrix as' -> 
  gen_new_col m n T as' = T × as'.
Proof. intros. 
       prep_genmatrix_equality.
       unfold GMmult, gen_new_col.
       rewrite Msum_Fsum.
       apply big_sum_eq_bounded; intros.
...
Lemma gen_new_row_is_mul : forall {m n} (T : GenMatrix m n) (as' : GenMatrix 1 m),
  WF_GenMatrix as' -> 
  gen_new_row m n T as' = as' × T.
Proof. intros. 
       prep_genmatrix_equality.
       unfold GMmult, gen_new_row.
       rewrite Msum_Fsum.
       apply big_sum_eq_bounded; intros.
...
Lemma col_add_many_mul : forall {m n} (T : GenMatrix m n) (as' : GenVector n) (i col : nat), 
  i < m ->
  col < n ->
  ((T × as')) i O = 
    (col_add_many
       (col_scale T col (as' col O)) 
       (make_row_val as' col 0%G) 
       col) i col.  
Proof. intros. 
       unfold col_add_many, GMmult, col_scale, make_row_val, gen_new_col. 
       rewrite Msum_Fsum.        
       bdestruct_all.
       destruct n; try lia.
       ...
       rewrite Gplus_assoc, Nat.add_0_r.
       rewrite (Gplus_comm _ (T i col * as' col O))%G.
...
(* We don't have adjoints for general fields *)
(* lemmas about operations w.r.t.involving adjoint *) 

(* Lemma col_swap_adjoint : forall {m n} (T : GenMatrix m n) (x y : nat), 
...
Lemma row_swap_adjoint : forall {m n} (T : GenMatrix m n) (x y : nat), 
...
Lemma col_scale_scalar : forall {m n} (T : GenMatrix m n) (x : nat) (a : F),
  a .* T = col_scale_many (col_scale T x a) (fun i j => if (j =? x) then 1%G else a).
Proof. intros. 
       prep_genmatrix_equality. 
...
Lemma row_scale_scalar : forall {m n} (T : GenMatrix m n) (x : nat) (a : F),
  a .* T = row_scale_many (row_scale T x a) (fun i j => if (i =? x) then 1%G else a).
Proof. intros. 
       prep_genmatrix_equality. 
...
Lemma col_add_many_col_add : forall {m n} (T : GenMatrix m n) (as' : GenVector n) (col e : nat),
...
Lemma col_add_many_cancel : forall {m n} (T : GenMatrix m (S n)) (as' : GenVector (S n)) (col : nat),
...
Lemma col_add_many_inv : forall {m n} (T : GenMatrix m n) (as' : GenVector n) (col : nat) ,
...
Lemma row_add_each_row_add : forall {m n} (T : GenMatrix m n) (as' : GenVector m) (row e : nat),
...
Lemma row_add_each_inv : forall {m n} (T : GenMatrix m n) (as' : GenVector m) (row : nat),
...
Lemma row_scale_many_transpose : forall {m n} (A : GenMatrix m n) (as' : GenVector m),
...
Lemma col_add_many_transpose : forall {m n} (A : GenMatrix m n) (as' : GenVector n) (col : nat),
...
Lemma row_add_each_transpose : forall {m n} (A : GenMatrix m n) (as' : GenVector m) (row : nat),
...
Lemma get_minor_transpose : forall {n} (A : GenSquare (S n)) (i j : nat),
...
Lemma cam_ca_switch : forall {m n} (T : GenMatrix m n) (as' : GenVector n) (col to_add : nat) (c : F),
...
Lemma col_add_many_preserves_mul_some : forall (m n o e col : nat) 
                                               (A : GenMatrix m n) (B : GenMatrix n o) (v : GenVector n),
...
Lemma row_each_col_many_invr_I : forall (n col : nat) (v : GenVector n),
  WF_GenMatrix v -> col < n -> v col 0 = 0%G ->
  row_add_each (I n) v col = col_add_many (I n) v col.  
Proof. intros. 
       rewrite <- (GMmult_1_r), <- col_add_many_preserves_mul, 
...
Proof. intros. 
       rewrite <- (GMmult_1_r), <- col_add_each_preserves_mul, 
         GMmult_1_l; auto with wf_db. 
Qed.


(* Now to the column/row operations matrices!! *)
Lemma col_swap_mult_r : forall {m n} (A : GenMatrix m n) (x y : nat),
...
Lemma row_swap_mult_l : forall {m n} (A : GenMatrix m n) (x y : nat),
  x < m -> y < m -> WF_GenMatrix A -> 
  row_swap A x y = (col_swap (I m) x y) × A.
Proof. intros.
       assert (H2 := (swap_preserves_mul (row_swap (I m) x y) A x y)). 
       rewrite <- (GMmult_1_l _ _ (row_swap A x y)); auto with wf_db.
...
Lemma col_scale_mult_r : forall {m n} (A : GenMatrix m n) (x : nat) (a : F),
  WF_GenMatrix A -> 
...
Lemma col_scale_many_mult_r : forall {m n} (A : GenMatrix m n) (as' : GenMatrix 1 n),
  WF_GenMatrix A -> 
...
Lemma col_add_mult_r : forall {m n} (A : GenMatrix m n) (x y : nat) (a : F),
  x < n -> y < n -> WF_GenMatrix A -> 
...
Lemma col_add_many_mult_r : forall {m n} (A : GenMatrix m n) (v : GenVector n) (col : nat),
...
Lemma col_add_each_mult_r : forall {m n} (A : GenMatrix m n) (v : GenMatrix 1 n) (col : nat),
...
Lemma get_minor_diag_mul : forall {n} (A : GenSquare (S n)) (v : GenVector (S n)) (i : nat),
  i < S n ->
  get_col A i = e_i i -> 
...
Lemma wedge_mul : forall {m n} (A : GenMatrix m n) (v : GenVector m) (a : GenVector n) (i : nat),
  i <= n ->
...
(* We don't have adjoints for general fields *)
(* Lemma matrix_by_basis_adjoint : forall {m n} (T : GenMatrix m n) (i : nat),
  i < m -> 
  get_row T i = (e_i i)† × T.
Proof. intros. 
       unfold get_row, e_i, GMmult, adjoint.
       prep_genmatrix_equality.
       bdestruct (x =? 0). 
       - rewrite (big_sum_unique (T i y) _ m); try easy.
         exists i. split.
         apply H. split.
         bdestruct (i =? i); bdestruct (i <? m); try lia; simpl; ring.  
         intros.
         bdestruct (x' =? i); try lia; simpl; ring. 
       - rewrite big_sum_0; try reflexivity.
         intros. rewrite andb_false_r. 
...
Lemma get_entry_with_e_i : forall {m n} (T : GenMatrix m n) (i j : nat),
  i < m -> j < n ->
...
Lemma matrix_by_basis_transpose : forall {m n} (T : GenMatrix m n) (i : nat),
  i < m -> 
  get_row T i = (e_i i)⊤ × T.
Proof. intros. 
       unfold get_row, e_i, GMmult, transpose.
       prep_genmatrix_equality.
       bdestruct (x =? 0). 
       - rewrite (big_sum_unique (T i y) _ m); try easy.
         exists i. split.
...
Lemma get_entry_with_e_i : forall {m n} (T : GenMatrix m n) (i j : nat),
  ...
  T i j = ((e_i i)⊤ × T × (e_i j)) O O.
Proof. intros.
       rewrite <- matrix_by_basis_transpose, <- matrix_by_basis; auto.
Qed.
...
Lemma pad1_scale : forall {m n : nat} (T : GenMatrix m n) (c c0 : F),
  c0 .* pad1 T c = pad1 (c0 .* T) (c0 * c)%G. 
Proof. intros. 
...
Lemma pad1_mult : forall {m n o : nat} (T1 : GenMatrix m n) (T2 : GenMatrix n o) (c1 c2 : F),
  pad1 (T1 × T2) (c1 * c2)%G = (pad1 T1 c1) × (pad1 T2 c2).
Proof. intros. 
       prep_genmatrix_equality. 
       unfold GMmult. 
       destruct x. 
...
(* Lemma pad1_adjoint : forall {m n} (T : GenMatrix m n) (c : F),
  (pad1 T c) † = pad1 (T†) (c^* ).
Proof. intros. 
       prep_genmatrix_equality.
       unfold pad1, adjoint, col_wedge, row_wedge, scale, e_i, Zero.
       bdestruct_all; subst; simpl; try ring.
Qed. *)

Lemma pad1_transpose : forall {m n} (T : GenMatrix m n) (c : F),
  (pad1 T c) ⊤ = pad1 (T⊤) c.
Proof. intros. 
       prep_genmatrix_equality.
       unfold pad1, transpose, col_wedge, row_wedge, scale, e_i, Zero.
       bdestruct_all; subst; simpl; try ring.
Qed.

Lemma pad1_row_wedge_mult : forall {m n} (T : GenMatrix m n) (v : GenVector n) (c : F),
...
Lemma pad1_I : forall (n : nat), pad1 (I n) 1%G = I (S n).
Proof. intros.  
       prep_genmatrix_equality. 
...
Lemma get_minor_pad1 : forall {m n : nat} (A : GenMatrix m n) (c : F),
...
Lemma pad1_reduce_colrow : forall {m n} (T : GenMatrix (S m) (S n)),
  (forall (i j : nat), (i = 0 \/ j = 0) /\ i <> j -> T i j = 0%G) ->
...
Lemma pad1_get_minor: forall {n : nat} (A : GenSquare (S n)) (c : F),
  (forall (i j : nat), (i = 0 \/ j = 0) /\ i <> j -> A i j = 0%G) ->
...
Lemma pad1ed_matrix : forall {m n} (A : GenMatrix (S m) (S n)) (c : F),
  (forall (i j : nat), (i = 0 \/ j = 0) /\ i <> j -> A i j = 0%G) -> A 0 0 = c ->
  exists a, pad1 a c = A.
Proof. intros.
...
Lemma vec_equiv_dec : forall {n : nat} (A B : GenVector n), 
    { A == B } + { ~ (A == B) }.
...
Lemma mat_equiv_dec : forall {m n} (A B : GenMatrix m n), 
    { A == B } + { ~ (A == B) }.
...
Lemma last_zero_simplification : forall {n : nat} (v : GenVector (S n)),
...
Lemma zero_reduce : forall {n : nat} (v : GenVector (S n)) (x : nat),
...
Lemma nonzero_vec_nonzero_elem : forall {n} (v : GenVector n),
  WF_GenMatrix v -> 
...
Fixpoint get_nonzero_entry (n : nat) (v : GenVector (S n)) : nat :=
  match n with 
  | O => O
...
Lemma get_nonzero_entry_bounds : forall {n} (v : GenVector (S n)),
  WF_GenMatrix v -> 
  get_nonzero_entry v < (S n).  
Proof. induction n. 
       - intros; simpl; auto. 
       - intros; simpl.
         destruct (Geq_dec (v 0 0) 0%G); try lia.
         apply -> Nat.succ_lt_mono.
         apply IHn; auto with wf_db.
Qed.

Lemma get_nonzero_entry_correct : forall {n} (v : GenVector (S n)),
  WF_GenMatrix v -> 
  v <> Zero ->
  v (get_nonzero_entry v) 0 <> 0%G.
Proof. induction n; intros.  
...
Lemma big_sum_rearrange : forall (n : nat) (f g : nat -> nat -> F),
  (forall x y, (x <= y)%nat -> f x y = (- 1%G) * (g (S y) x))%G ->
  (forall x y, (y <= x)%nat -> f (S x) y = (- 1%G) * (g y x))%G ->
...
Proof. induction n as [| n'].
       ...
       - intros. 
         ...
         do 2 rewrite (@big_sum_mult_l F R0 R1 R2 R3).  
         rewrite Gplus_comm.
         f_equal.
         all : apply big_sum_eq_bounded; intros. 
         apply H; lia. 
...
Lemma parity_sqr : forall (n : nat),
  (parity n * parity n)%G = 1%G.
Proof. intros. 
       induction n.
       - simpl; ring.
       - rewrite parity_S.
         replace (- (1%G) * parity n * (- (1%G) * parity n))%G with (parity n * parity n)%G by ring.
         easy.
Qed.

Lemma parity_plus : forall (n m : nat),
  parity (n + m) = (parity n * parity m)%G.
Proof. intros. 
       induction n.
       - simpl; ring.
...
Fixpoint Determinant (n : nat) (A : GenSquare n) : F :=
  match n with 
  | 0 => 1%G
  | S 0 => A 0 0
  | S n' => (big_sum (fun i => (parity i) * (A i 0) * 
                                 (Determinant n' (get_minor A i 0)))%G n)
  end.

Arguments Determinant {n}.

Lemma Det_simplify : forall {n} (A : GenSquare (S n)),
  Determinant A =  
...
Lemma Det_simplify_fun : forall {n} (A : GenSquare (S (S n))),
...
Lemma Det_I : forall (n : nat), Determinant (I n) = 1%G.
Proof. intros.
       induction n as [| n'].
       - easy.
       - simpl. destruct n'; try easy.
         ...
         replace (I (S (S n')) (S x) 0) with 0%G by easy.
         ring. 
Qed.

Lemma Det_make_WF : forall (n : nat) (A : GenSquare n),
...
Lemma Det_Mmult_make_WF_l : forall (n : nat) (A B : GenSquare n),
...
Lemma Det_Mmult_make_WF_r : forall (n : nat) (A B : GenSquare n),
...
Lemma Det_Mmult_make_WF : forall (n : nat) (A B : GenSquare n),
...
Definition M22 : GenSquare 2 :=
  fun x y => 
  match (x, y) with
  | (0, 0) => 1%G
  | (0, 1) => (1%G+1%G)%G
  | (1, 0) => (1%G+1%G+1%G+1%G)%G
  | (1, 1) => (1%G+1%G+1%G+1%G+1%G)%G
  | _ => 0%G
  end.


Lemma Det_M22 : (Determinant M22) = (Gopp (1%G + 1%G + 1%G))%G.
...
Lemma Determinant_col_scale : forall {n} (A : GenSquare n) (c : F) (col : nat),
...
Lemma Determinant_row_scale : forall {n} (A : GenSquare n) (c : F) (row : nat),
  row < n -> Determinant (row_scale A row c) = (c * Determinant A)%G.
Proof. induction n.
       - intros. easy.
       - intros. 
         do 2 rewrite Det_simplify.
...
Lemma Determinant_scalar : forall {n} (A : GenSquare n) (c : F),
  Determinant (c .* A) = ((G_big_mult (repeat c n)) * Determinant A)%G.
Proof. induction n.
       - intros; simpl; ring.
       - intros. 
         do 2 rewrite Det_simplify.
...
Lemma Det_diff_1 : forall {n} (A : GenSquare (S (S n))),
  Determinant (col_swap A O 1) = 
  big_sum (fun i => (big_sum (fun j => ((A i 1%nat) * (A (skip_count i j) O) * (parity i) * (parity j) * 
                             Determinant (get_minor (get_minor A i O) j O))%G )  
                             (S n))) (S (S n)).
Proof. intros. 
       rewrite Det_simplify.
       ...
       setoid_rewrite H'.    
       apply f_equal_gen; try apply f_equal; try easy. 
       unfold col_swap. simpl. ring.
Qed.

Lemma Det_diff_2 : forall {n} (A : GenSquare (S (S n))),
  Determinant A = 
  big_sum (fun i => (big_sum (fun j => ((A i 0) * (A (skip_count i j) 1%nat) * (parity i) * (parity j) * 
                             Determinant (get_minor (get_minor A i 0) j 0))%G)  
                             (S n))) (S (S n)).
Proof. intros. 
       rewrite Det_simplify.
       rewrite Det_simplify_fun.
...
Lemma Determinant_swap_01 : forall {n} (A : GenSquare n),
...
Lemma Determinant_swap_adj : forall {n} (A : GenSquare n) (i : nat),
...
Lemma Determinant_swap_ik : forall {n} (k i : nat) (A : GenSquare n),
...
Lemma Determinant_swap : forall {n} (A : GenSquare n) (i j : nat),
  i < n -> j < n -> i <> j ->
...
Lemma Determinant_swap' : forall {n} (A : GenSquare n) (i j : nat),
  i < n -> j < n -> i <> j ->
  (Determinant A) = -1%G * Determinant (col_swap A i j).
Proof. intros.
  rewrite Determinant_swap; auto; ring.
Qed.

Lemma Determinant_col_to_front : forall {n} (col : nat) (A : GenSquare n),
  col < n -> 
...
Lemma Determinant_col_to_front' : forall {n} (col : nat) (A : GenSquare n),
  col < n -> 
  Determinant A = (parity col) * Determinant (col_to_front A col).
Proof. intros.
...
Lemma col_0_Det_0 : forall {n} (A : GenSquare n) (i : nat),
  i < n -> 
  get_col A i = Zero -> 
  Determinant A = 0%G.
Proof. intros n A i H H0.
       ...
       destruct n.
       destruct i; try lia. 
       replace 0%G with (@Zero 1 1 0 0)%G by easy.  
       rewrite <- H0. easy. 
       destruct i.
       - rewrite Det_simplify.
         apply (@big_sum_0_bounded F); intros. 
...
Lemma row_0_Det_0 : forall {n} (A : GenSquare n) (i : nat),
  i < n -> 
  get_row A i = Zero -> 
  Determinant A = 0%G.
Proof. induction n.
       ...
       - intros; destruct n.
         ...
         + rewrite Det_simplify. 
           ...
           rewrite <- get_row_conv, H0; unfold Zero; ring.
           rewrite (IHn _ i); try ring; try lia.
           2 : rewrite (IHn _ (i - 1)%nat); try ring; try lia.
           all : unfold get_row, get_minor.
           all : prep_genmatrix_equality.
           all : bdestruct_all; try easy.
           2 : replace (1 + (i - 1))%nat with i by lia.
           all : rewrite <- get_row_conv, H0; unfold Zero; ring.
Qed.           

(* This method of proof does not work since we might have -1 = 1 in the field
Lemma col_same_Det_0 : forall {n} (A : GenSquare n) (i j : nat),
  i < n -> j < n -> i <> j -> 
...
Proof. intros. 
       ...
       rewrite (det_by_get_col (col_swap A i j) A); try easy; intros. 2: {
       prep_genmatrix_equality. 
       destruct y; try easy.
...
Lemma col_same_Det_0 : forall {n} (A : GenSquare n) (i j : nat),
  ...
  Determinant A = 0%G.
Proof. intros.
  do 3 (destruct n; try lia).
  - unfold Determinant, get_minor.
    simpl. dumb_lRa.
    unfold get_col in H2.
    remember H2 as H3. clear HeqH3.
    apply f_equal_inv with (x := 0) in H2.
    apply f_equal_inv with (x := 0) in H2.
    apply f_equal_inv with (x := 1%nat) in H3.
    apply f_equal_inv with (x := 0) in H3.
    simpl in H2, H3.
    bdestruct (i =? 0)%nat; bdestruct (i =? 1)%nat;
    bdestruct (j =? 0)%nat; bdestruct (j =? 1)%nat;
    try lia; subst; rewrite ! H2, H3; ring.
  - gen A i j. induction n; intros.
    + unfold Determinant, get_minor.
      simpl. dumb_lRa.
      unfold get_col in H2.
      remember H2 as H3. clear HeqH3.
      ...
      apply f_equal_inv with (x := 2%nat) in H4.
      apply f_equal_inv with (x := 0%nat) in H4.
      simpl in H2, H3, H4.
      bdestruct (i =? 0)%nat; bdestruct (i =? 1)%nat; bdestruct (i =? 2)%nat;
      bdestruct (j =? 0)%nat; bdestruct (j =? 1)%nat; bdestruct (j =? 2)%nat;
      try lia; subst; 
      try rewrite H2; try rewrite H3; try rewrite H4;
      try ring.
    + bdestruct (i <? j).
    * rewrite (Determinant_col_to_front' i A).
      rewrite (Determinant_col_to_front' j (col_to_front A i)).
      rewrite Gmult_assoc.
      rewrite <- parity_plus.
      rewrite (Determinant_col_to_front' 2%nat (col_to_front (col_to_front A i) j)).
      all: try lia.
      replace (parity 2) with 1%G by auto.
      rewrite Gmult_1_l.
      rewrite Det_simplify.
      do 2 rewrite <- big_sum_extend_l.
      rewrite Gplus_assoc. 
      assert (parity 0 * col_to_front (col_to_front (col_to_front A i) j) 2 0 0 *
                Determinant (get_minor (col_to_front (col_to_front (col_to_front A i) j) 2) 0 0) +
                parity 1 * col_to_front (col_to_front (col_to_front A i) j) 2 1%nat 0 *
                  Determinant (get_minor (col_to_front (col_to_front (col_to_front A i) j) 2) 1 0) = 0).
      { unfold parity.
        assert (Determinant (get_minor (col_to_front (col_to_front (col_to_front A i) j) 2) 0 0) = 0).
        { apply IHn with (i := 0%nat) (j := 1%nat);
            auto; try lia.
          unfold get_col.
          prep_genmatrix_equality.
          bdestruct_all; subst; auto.
          unfold get_minor; bdestruct_all; subst.
          repeat (unfold col_to_front at 1; bdestruct_all; subst).
          unfold get_col in H2.
          apply f_equal_inv with (x := (1 + x)%nat) in H2.
          apply f_equal_inv with (x := 0%nat) in H2.
          simpl in H2. simpl.
          rewrite H2. auto. }
        rewrite H4.
        assert (Determinant (get_minor (col_to_front (col_to_front (col_to_front A i) j) 2) 1 0) = 0).
        { apply IHn with (i := 0%nat) (j := 1%nat);
            auto; try lia.
          unfold get_col.
          prep_genmatrix_equality.
          ...
          - repeat (unfold col_to_front at 1; bdestruct_all; subst).
            unfold get_col in H2.
            apply f_equal_inv with (x := x%nat) in H2.
            apply f_equal_inv with (x := 0%nat) in H2.
            simpl in H2. simpl.
            rewrite H2. auto.
          - repeat (unfold col_to_front at 1; bdestruct_all; subst).
      ...
      rewrite Gplus_0_l.
      rewrite big_sum_0_bounded; try ring; intros.
      assert (Determinant (get_minor (col_to_front (col_to_front (col_to_front A i) j) 2) (S (S x)) 0) = 0).
      { apply IHn with (i := 0%nat) (j := 1%nat);
            auto; try lia.
          unfold get_col.
          prep_genmatrix_equality.
          ...
          - repeat (unfold col_to_front at 1; bdestruct_all; subst).
            unfold get_col in H2.
            apply f_equal_inv with (x := x0%nat) in H2.
            apply f_equal_inv with (x := 0%nat) in H2.
            simpl in H2. simpl.
            rewrite H2. auto.
          - repeat (unfold col_to_front at 1; bdestruct_all; subst).
            unfold get_col in H2.
            apply f_equal_inv with (x := (1 + x0)%nat) in H2.
            apply f_equal_inv with (x := 0%nat) in H2.
            simpl in H2. simpl.
            rewrite H2. auto. }
      rewrite H6.
      ring.
    * rewrite (Determinant_col_to_front' i A).
      rewrite (Determinant_col_to_front' (S j) (col_to_front A i)).
      rewrite Gmult_assoc.
      rewrite <- parity_plus.
      rewrite (Determinant_col_to_front' 2%nat (col_to_front (col_to_front A i) (S j))).
      all: try lia.
      replace (parity 2) with 1%G by auto.
      rewrite Gmult_1_l.
      rewrite Det_simplify.
      do 2 rewrite <- big_sum_extend_l.
      rewrite Gplus_assoc. 
      assert (parity 0 * col_to_front (col_to_front (col_to_front A i) (S j)) 2 0 0 *
                Determinant (get_minor (col_to_front (col_to_front (col_to_front A i) (S j)) 2) 0 0) +
                parity 1 * col_to_front (col_to_front (col_to_front A i) (S j)) 2 1%nat 0 *
                  Determinant (get_minor (col_to_front (col_to_front (col_to_front A i) (S j)) 2) 1 0) = 0).
      { unfold parity.
        assert (Determinant (get_minor (col_to_front (col_to_front (col_to_front A i) (S j)) 2) 0 0) = 0).
        { apply IHn with (i := 0%nat) (j := 1%nat);
            auto; try lia.
          unfold get_col.
          prep_genmatrix_equality.
          ...
          repeat (unfold col_to_front at 1; bdestruct_all; subst).
          unfold get_col in H2.
          replace (S j - 1)%nat with j by lia.
          apply f_equal_inv with (x := (1 + x)%nat) in H2.
          apply f_equal_inv with (x := 0%nat) in H2.
          simpl in H2. simpl.
          rewrite H2. auto. }
        rewrite H4.
        assert (Determinant (get_minor (col_to_front (col_to_front (col_to_front A i) (S j)) 2) 1 0) = 0).
        { apply IHn with (i := 0%nat) (j := 1%nat);
            auto; try lia.
          unfold get_col.
          prep_genmatrix_equality.
      ...
      rewrite Gplus_0_l.
      rewrite big_sum_0_bounded; try ring; intros.
      assert (Determinant (get_minor (col_to_front (col_to_front (col_to_front A i) (S j)) 2) (S (S x)) 0) = 0).
      { apply IHn with (i := 0%nat) (j := 1%nat);
            auto; try lia.
          unfold get_col.
          prep_genmatrix_equality.
...
Lemma Det_col_add_comm : forall {n} (T : GenMatrix (S n) n) (v1 v2 : GenVector (S n)),
...
Lemma Determinant_col_add0i : forall {n} (A : GenSquare n) (i : nat) (c : F),
...
Lemma Determinant_col_add : forall {n} (A : GenSquare n) (i j : nat) (c : F),
...
Lemma Determinant_pad1 : forall {n} (A : GenSquare n) (c : F), 
  Determinant (pad1 A c) = c * Determinant A.
Proof. intros.
       rewrite Det_simplify, <- big_sum_extend_l, <- Gplus_0_r.
       apply f_equal_gen; try apply f_equal.
...
Lemma determinant_along_col : forall {n} (A : GenSquare (S (S n))) (col rep : nat),
  rep < S (S n) ->
...
Proof. intros. 
       ...
       rewrite <- Determinant_col_to_front; auto.
       rewrite Det_simplify, (@big_sum_mult_l F R0 R1 R2 R3).
       apply big_sum_eq_bounded; intros.
...
Definition adjugate {n} (A : GenSquare n) : GenSquare n :=
  match n with 
  | O => fun i j => 0%G
...
Lemma WF_adjugate : forall {n} (A : GenSquare n),
  WF_GenMatrix (adjugate A).
Proof. intros.
       destruct n;
       unfold WF_GenMatrix, adjugate; intros; auto. 
       bdestruct_all; easy.
Qed.
...
Lemma mult_by_adjugate_single_col : forall {n} (A : GenSquare n) (col rep : nat),
  col < n -> rep < n ->
...
Theorem mult_by_adjugate_l : forall {n} (A : GenSquare n), 
  WF_GenMatrix A -> 
  (adjugate A) × A = (Determinant A) .* (I n). 
Proof. intros. 
       destruct n.
       prep_genmatrix_equality.
       unfold GMmult, scale, I; simpl.
       bdestruct_all; try lia; simpl; ring.
       apply genmat_equiv_eq; auto with wf_db.
       unfold genmat_equiv; intros.
       unfold GMmult.
       ...
       - replace (col_replace A j j) with A.         
         ...
         prep_genmatrix_equality.
         bdestruct_all; auto.
       - rewrite (col_scale_same_Det_0 _ i j 1%G); auto.
         simpl; ring.
