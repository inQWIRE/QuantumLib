...
Proof. intros. 
       ...
       rewrite <- Gpow_int_cons in *.
       replace (S n) with (1 + n)%nat by lia.
       rewrite Nat2Z.inj_add, Z.pow_add_r, Gpow_add_r; try lia.
       rewrite mult_IZR, <- IHn, RtoC_mult.
       apply f_equal_gen; auto; apply f_equal; simpl. 
...
Proof. intros.
       ...
       do 2 rewrite Cmult_assoc, <- (@Gpow_int_add_r C _ _ _ C_is_ring) in H.
...
Proof. intros. 
       ...
       { induction n0; auto.
         ...
         rewrite (@Gpow_int_add_r C); try easy.
         apply RtoC_neq; lra. }
       rewrite H' in H. 
       simpl in H.
...
Proof. intros.
       ...
       - unfold Dplus, DtoC. 
         ...
         lca.
         rewrite <- (@Gpow_int_add_r C _ _ _ C_is_ring).
         apply f_equal; lia.
         apply RtoC_neq; lra.
...
Proof. intros.
       ...
       rewrite Gpow_pos_to_nat, Cmult_0_r, Cplus_0_l, Cmult_1_r, Cmult_1_r, Cpow_Gpow.
       easy. 
Qed.       
